...
/**
  ...
  * original -> https://github.com/GatsbyNewton/learning-flink/blob/870820a474/flink-table/src/main/scala/edu/wzm/source/MyTableSource.scala
  */
class MyTableSource extends StreamTableSource[Row] with DefinedRowtimeAttributes {
  ...
  val schema: TableSchema = new TableSchema(fieldNames, Array(Types.SQL_TIMESTAMP, Types.STRING, Types.STRING))
